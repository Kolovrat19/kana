...
List<Offset> writeSvgPathDataToPath(String? svg, PathProxy path) {
  List<Offset> listTargetPoints = [];
  if (svg == null || svg == '') {
    return listTargetPoints;
  }
  ...
  for (PathSegmentData seg in parser.parseSegments()) {
    ...
    listTargetPoints.add(Offset(seg.targetPoint.dx, seg.targetPoint.dy));
  }
  return listTargetPoints;
}
